...
def cifar10_classification():
    st.title("CIFAR-10 Image Classification From Sahil Jamadar's model")
...
#i have install all the epoches which are needed for run an application where streamlit 
#run our file by -----------streamlit run app.py